...
internal sealed class StdErrParseResult(IEnumerable<SassMessage> errors, IEnumerable<SassMessage> warnings, IEnumerable<SassDeprecationWarning> deprecationWarnings, IEnumerable<SassMessage> debug)
{
