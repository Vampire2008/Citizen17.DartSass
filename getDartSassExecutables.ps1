...
downloadAndExtract "linux-musl-x64.tar.gz"   "Linux musl x64"
downloadAndExtract "linux-musl-ia32.tar.gz"  "Linux musl x86"
downloadAndExtract "linux-musl-arm.tar.gz"   "Linu muslx arm"
downloadAndExtract "linux-musl-arm64.tar.gz" "Linux musl arm64"
